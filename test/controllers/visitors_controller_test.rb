...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { age: @visitor.age, email: @visitor.email, name: @visitor.name } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { age: @visitor.age, email: @visitor.email, name: @visitor.name } }
